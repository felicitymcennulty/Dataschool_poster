...
?how to edit in this given it has "output: DSreport::project_summary" in title bar
output: 
  html_document:
    code_folding: hide
***************
...
**Plots from R**
Here is a ggplot showing the density of fish, note that the areas these fish are found are very small.
